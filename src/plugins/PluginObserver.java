...
/**
 * Abstract class plugin observer is in charge of "watching" the file to see if any files has been added
 *
 */
public abstract class PluginObserver {
	 ...
	 * @param pluginFinder used to determinates which files are plugin
	 */
	 ...
	 * @param dir directory containing the plugins
	 * @param added name of the files that has been added 
	 */
	 ...
	 * @param dir directory containing the plugins
	 * @param deleted name of the files that has been removed
	 */
